...
input_path = "./../resources/corpora/raw/oscar/"
output_path = "./../resources/corpora/processed/oscar"

# Let's prepare regexes to be used throughout this script.
corpus_input_file_name_pattern = re.compile("sk_meta_part_[0-9]+.jsonl")
...
for input_corpus_file in input_corpus_files:
    ...
    with open(input_corpus_file, 'r', encoding='utf-8') as input_file:
        for line in input_file:
            ...
            print(input_corpus_file, ' ', str(current_line_counter))
